-- First, let's add the admin user
...
DROP POLICY IF EXISTS "Users can view their company or admins can view all" ON public.companies;
...
DROP POLICY IF EXISTS "Users can view their company submissions or admins can view all" ON public.submissions;
...
DROP POLICY IF EXISTS "Users can update draft submissions for their company or admins can update any" ON public.submissions;
...
DROP POLICY IF EXISTS "Users can view their company responses or admins can view all" ON public.responses;
...
DROP POLICY IF EXISTS "Users can insert draft responses or admins can insert any" ON public.responses;
...
DROP POLICY IF EXISTS "Users can update draft responses or admins can update any" ON public.responses;
